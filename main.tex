...
\begin{table}[ht!]
  ...
  \begin{tabular}{cc}
    ...
    \begin{tabular}{|l|c|c|c|c|}
      ...
      b          & \((3.5, \infty)\)  & green       & no          & \((-\infty, 17)\) \\ \hline
    \end{tabular}
    \\ \\
    % Second Row of Subtables
    \multicolumn{2}{c}{
      \begin{tabular}{|l|c|c|c|c|}
        \hline
        \multicolumn{5}{|c|}{Label Encoding} \\ \hline
        \textbf{y} & \textbf{f1} & \textbf{f2} & \textbf{f3} & \textbf{f4} \\ \hline
        a          & 0           & 0           & 1           & 2           \\
        a          & 3           & 1           & 0           & 2           \\
        a          & 1           & 1           & 1           & 1           \\
    ...
    \multicolumn{2}{c}{
      \begin{tabular}{|l|c|c|c|c|c|c|c|}
        \hline
        \multicolumn{8}{|c|}{Binarized Values} \\ \hline
        \textbf{y} & \textbf{b1\_1} & \textbf{b1\_0} & \textbf{b2\_1} & \textbf{b2\_0} & \textbf{b3} & \textbf{b4\_1} & \textbf{b4\_0} \\ \hline
...
\begin{table}[ht!]
  ...
  % Subtable 1: For Minimum 1 Matching Sample
  ...
  % Subtable 2: For Minimum 10 Matching Samples
  \begin{tabular}{|c|c|c|c|c|c|c|}
    \hline
  ...
  % Subtable 3: For Minimum 50 Matching Samples
  \begin{tabular}{|c|c|c|c|c|c|c|}
    \hline
